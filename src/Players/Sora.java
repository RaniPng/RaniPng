...
public class Sora extends Player {
	...
	public Sora(TileMap tm) {

		super(tm);

		_NUMFRAMES = new int[] { 2, 8, 3, 3, 3, 6, 6, 5, 5, 8, 5, 5, 7, 7, 7, 4, 4, 6, 5, 3 };

		_FRAMEWIDTHS = new int[] { 34, 47, 30, 30, 32, 51, 39, 70, 76, 72, 52, 57, 44, 38, 1, 45, 55, 39, 38, 27 };
		_FRAMEHEIGHTS = new int[] { 53, 45, 55, 48, 48, 47, 44, 60, 47, 45, 74, 47, 80, 59, 48, 45, 24, 60, 44, 50 };

		_SPRITEDELAYS = new int[] { 2000, 100, 50, 200, 70, 60, 150, 100, 100, 100, 100, 160, 130, 120, 100, 600, 630,
				150, 70, 130 };
	...
	protected void getNextPosition() {
		...
		if (_rolling) {
			_dx = 0;
			if (_currentAction == _ROLLING && _animation.getFrame() == 4)
